...
VDRControl::Connect(wxEVT_LEFT_DOWN, &VDRControl::OnMouseEvent, g_Window);
VDRControl::Connect(wxEVT_LEFT_UP, &VDRControl::OnMouseEvent, g_Window);
VDRControl::Connect(wxEVT_MOTION, &VDRControl::OnMouseEvent, g_Window);
...
void VDRControl::OnPopupClick(wxCommandEvent& evt) {
  switch (evt.GetId()) {
    case ID_DASH_RESIZE:
      m_binResize = true;
      break;
...
void VDRControl::OnDLeftClick(wxMouseEvent& event) {
  wxMenu mnu;
  mnu.Append(ID_DASH_RESIZE, "Resize...");
  // mnu.Append(ID_SOMETHING_ELSE, "Do something else");
  mnu.Connect(wxEVT_COMMAND_MENU_SELECTED,
              wxCommandEventHandler(VDRControl::OnPopupClick), NULL, this);
  PopupMenu(&mnu);
}
...
void VDRControl::OnContextMenuSelect(wxCommandEvent& event) {
  //
  switch (event.GetId()) {
    case ID_DASH_RESIZE: {
      /*
